...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="/system/feedback/home.do"><i class="fa fa-dashboard"></i> 首页</a></li>
            <li><a href="/system/feedback/list.do">反馈列表</a></li>
        </ol>
    </section>
    <!-- 内容头部 /-->
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/system/feedback/updateFeedback.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        ${feedback.classType == '1' ?'管理':''}
                        ${feedback.classType == '2' ?'安全':''}
                        ${feedback.classType == '3' ?'建议':''}
                        ${feedback.classType == '4' ?'其他':''}
                    </div>
                    ...
                    <div class="col-md-4 data">
                        ${feedback.difficulty == '1' ?'极难':''}
                        ${feedback.difficulty == '2' ?'比较难':''}
                        ${feedback.difficulty == '3' ?'有难度':''}
                        ${feedback.difficulty == '4' ?'一般':''}
                    </div>

                    <div class="col-md-2 title">是否公开</div>
                    <div class="col-md-4 data">
                        ${feedback.isShare == '1' ?'公开':''}
                        ${feedback.isShare == '0' ?'不公开':''}
                    </div>
                    ...
                    <div class="col-md-4 data rowHeight2x">
                        <fmt:formatDate value="${feedback.inputTime}" pattern="yyyy-MM-dd"/>
                    </div>

                    <div class="col-md-2 title">处理人</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="处理人" name="answerBy" value="${feedback.answerBy}">
                    </div>
                    ...
                    <div class="col-md-4 data  rowHeight2x">
                        <textarea class="form-control" rows="3" placeholder="处理方式" name="solveMethod">${feedback.solveMethod}</textarea>
                    </div>
                    ...
                    <div class="col-md-4 data rowHeight2x">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="解决日期"  name="answerTime" class="form-control pull-right"
                                   value="<fmt:formatDate value="${feedback.answerTime}" pattern="yyyy-MM-dd"/>" id="answerTime">
                        </div>
                    </div>
                </div>
            </form>
